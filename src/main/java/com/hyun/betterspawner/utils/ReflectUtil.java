...
public class ReflectUtil {
     ...
     */
    public static boolean isVersionHigherOrEqual(int majorVersion, int minorVersion, int build) {
        return MAJOR_VERSION > majorVersion || (majorVersion == MAJOR_VERSION && MINOR_VERSION > minorVersion) ||
     ...
     * @return true, only if the current version is greater than the one specified
     */
    public static boolean isVersionHigherOrEqual(int majorVersion, int minorVersion) {
        return isVersionHigherOrEqual(majorVersion, minorVersion, 0);
    }
